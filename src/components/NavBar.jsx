    ...
    <>
      <motion.div
        ...
        className={`fixed top-0 left-0 w-full z-50 transition-colors duration-500 ${
          lastScrollY
            ? "bg-white opacity-90 backdrop-blur-md"
            : "bg-transparent"
        }`}
      >
        <div className="flex justify-between items-center py-4 px-8">
          ...
          <div className="flex items-center space-x-3 pr-9">
            ...
            <Button
              ...
              className="relative bg-transparent text-black hover:bg-transparent hover:text-black border border-black rounded-full px-5 py-4 text-2xl font-semibold font-Onest overflow-hidden group transform transition-all duration-500 w-[40px] h-[40px] shadow-none"
            >
              {/* Initial Text */}
              <span className="absolute inset-0 flex items-center justify-center transform transition-transform duration-500 group-hover:translate-y-[-100%]">
                =
