...
>
  ...
  <div className="bg-gray-100 rounded-lg overflow-hidden shadow-md relative">
    <img
      src="/images/work-1.jpg" // Replace with your actual image
      alt="Work Image"
    ...
    <div className="p-4">
      <h3 className="text-lg font-bold">Romans & Partners</h3>
  ...
  <div className="bg-gray-100 rounded-lg overflow-hidden shadow-md">
    <img
      src="/images/work-2.jpg" // Replace with your actual image
      alt="Work Image"
      className="w-full h-48 object-cover"
    />
    <div className="p-4">
      <h3 className="text-lg font-bold">Alveen Interior</h3>
      <div className="flex space-x-2 mt-2">
        <span className="px-3 py-1 border rounded-full text-sm">
          UI/UX Design
        </span>
